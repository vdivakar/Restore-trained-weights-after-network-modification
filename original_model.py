...
'''
This file will save checkpoint for the original model.
This will be used by modified network for restoring weights.
'''
...
with tf.Session() as sess:
    ...
    save_path = saver_full.save(sess, "checkpoint/model-original")
